...
<head>
    <meta charset="UTF-8">
    <title>Choix des candidats</title>
      ...
      <div class="row">
       ...
       <div class="row interface">
           ...
           <div class="col-md-9 corps">
               ...
               <h3 class="titre">Choix des candidats</h3>
               <form method="post" action="" class="text-center">
                 
                <div class="liste">
                 
                  <input type="checkbox" id="c1" name="cand" />
                  <label for="c1" class="row cand"><span class="col-md-7">Cheikh KEBE</span> <span class="col-md-5">5 sessions</span> </label>
                  
                  <input type="checkbox" id="c2" name="cand" />
                  <label for="c2" class="row cand"><span class="col-md-7">Dieylani DRAME</span> <span class="col-md-5">5 sessions</span> </label>
                  
                  <input type="checkbox" id="c3" name="cand" />
                  <label for="c3" class="row cand"><span class="col-md-7">Mafé Yapp</span> <span class="col-md-5">5 sessions</span> </label>
                </div>
