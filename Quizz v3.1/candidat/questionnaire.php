...
<body class="container">
      <div class="row">
       ...
       <div class="row question text-center animated slideInRight">
           <i class="col-md-2"></i>
           <span class="col-md-2">Question<span class="numquestion" id="numquestion">#<?php echo $_SESSION["indice"]; ?></span></span><span class="col-md-4 laquestion" id="laquestion"><?php echo $d1["libelle"];?></span><span class="col-md-2"><span class="timer"><i class="glyphicon glyphicon-time"> </i> <span id="temps"> 12</span></span></span>
           <i class="col-md-2"></i>
       </div>
