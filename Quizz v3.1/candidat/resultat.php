      ...
      <div class="row">
       <span class="col-md-12 titre"><span class="sq"><div class="animated bounceInDown">SuperQuizz</div></span></span>
        ...
        <div class="row resultats">
            <h4 class="col-md-12 petittitre"><u><div class="animated slideInLeft">Résultats de <?php echo ucfirst($d2["prenom"])." ".ucfirst($d2["nom"]);?></div></u></h4>
            <table  class="col-md-10 table table-hover table-bordered text-center animated zoomIn" style="animation-delay:1s" id="tableau">
                ...
                ?>
                <tr><td><?php echo $i;?></td><td><?php echo $d1["libelle"];?></td><td><?php echo $d1["choix".$d1["reponse"]];?></td><td><?php if($d["choix"]) echo $d1["choix".$d["choix"]];  else echo "<em>Vous n'avez pas répondu</em>"?></td><td><img width="30" height="30" class="emoji" src="../images/<?php echo $m;?>"/></td><td><?php echo $d["points"];?></td><td><?php echo $d["temps"];?></td><td><?php echo $d1["coef"]."%"; ?></td></tr>
        ...
        <a href="accueil.php" class="btn btn-info animated bounce" style="animation-delay:3s"><i class="glyphicon glyphicon-home"></i> <span class="animated bounce" style="animation-delay:3s"> Retour à l'accueil</span></a>
        </div>
        <footer class="row col-md-12 footer2">
